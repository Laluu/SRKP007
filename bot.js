...
${chalk.blue.italic('ℹ️ Connecting to WhatsApp... Please wait.')}`);
    ...
    conn.on('open', async () => {
        ...
        console.log(
            chalk.green.bold('srkp007 Running! 🤩')
        );
    });
...
*/
                        try {
                            ...
                            if (error.message.includes('URL')) {
                                    return await WhatsAsenaCN.sendMessage(WhatsAsenaCN.user.jid, '*♨️🌀 HATA ÇÖZÜMLEME [💓👩‍❤️‍👨______ *𝙎𝙍𝙆𝙋007* _____🕊️♥️] ♨️🌀*' + 
                                        '\n========== ```Hata Okundu!``` ==========' +
                                        '*\n\n Max Error oyvakkan BOT NTA COMMENTS MANASIL AKKUKA+
                                    ...
                                    return await WhatsAsenaCN.sendMessage(WhatsAsenaCN.user.jid, '*♨️🌀 HATA ÇÖZÜMLEME [💓👩‍❤️‍👨______ 𝐏𝐈𝐊𝐀𝐂𝐇𝐔 _____🕊️♥️] ♨️🌀*' + 
                                        '\n========== ```Hata Okundu!``` ==========' +
                                        '*\n\n Max Error oyvakkan BOT NTA COMMENTS MANASIL AKKUKA+
                                    ...
                                    return await WhatsAsenaCN.sendMessage(WhatsAsenaCN.user.jid, '*♨️🌀 ERROR ANALYSIS [💓👩‍❤️‍👨______ *𝙎𝙍𝙆𝙋007* _____🕊️♥️] ♨️🌀*' + 
                                        '\n==========*ꫀ𝘳𝘳ꪮ𝘳 𝐑𝐄𝐒𝐨𝐋𝐕𝐄𝐃* ==========' +
                                        '*\n\n Max Error oyvakkan BOT NTA COMMENTS MANASIL AKKUKA+
